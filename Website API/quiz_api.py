...
def votea():
    ...
    TOTAL_VOTES[0] += 1
    return flask.render_template("voted_a.html", votes_a=str(TOTAL_VOTES[0]), votes_b=str(TOTAL_VOTES[1]))
...
def voteb():
    ...
    # SQL_CONNECTION.commit()
    TOTAL_VOTES[1] += 1
    return flask.render_template("voted_b.html", votes_a=str(TOTAL_VOTES[0]), votes_b=str(TOTAL_VOTES[1]))
